...
import com.caribou.company.domain.AbstractEntity;
...
public abstract class EmbeddableResourceAssemblerSupport<T extends AbstractEntity, D extends ResourceSupport, C> extends ResourceAssemblerSupport<T, D> {
