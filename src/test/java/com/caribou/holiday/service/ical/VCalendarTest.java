        ...
        VCalendar generateCalendar = VCalendar.builder()
                ...
                .vEvents(Collections.singletonList(
                        VEvent.builder()
                                ...
                                .dtstamp(LocalDateTime.of(2017, 7, 11, 20, 7, 23, 0).toInstant(ZoneOffset.UTC))
                                .uid("r0somb3deuokerbf6bj6vncft4@google.com")
                                .created(LocalDateTime.of(2006, 4, 13, 16, 59, 51, 0).toInstant(ZoneOffset.UTC))
                                .description("")
                                .lastModified(LocalDateTime.of(2015, 7, 6, 16, 39, 39, 0).toInstant(ZoneOffset.UTC))
                                .location("")
